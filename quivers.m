...
hx=get(gca,'xlim'); hy=get(gca,'ylim'); lx=(hx(2)-hx(1))/5; ly=lx/4; 
...
%Alex: modification to get right dimensions of scale box    
%rx = rx + 0.8;
%lx = lx - 1;
%ly = ly - 0.1;
...
%Alex: modification to get text in right place
%rx = rx + 0.3;
